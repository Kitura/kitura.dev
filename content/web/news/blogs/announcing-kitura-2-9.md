...
A [new KituraKit guide](/docs/client/iOSClient) has been added to the kitura.dev website demonstrating how KituraKit can be used to talk to a Kitura service.
