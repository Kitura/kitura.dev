    ...
    return (
        <section className={styles.codeExampleSection}>
            <div className={styles.leftButtonSection}>
                <Button name="Handle requests" isActive={index===0} value={0} />
                <Button name="Handle requests with Codable" isActive={index===1} value={1} />
            ...
            <div className={styles.rightButtonSection}>
                ...
                <Button name={"Add OpenAPI support"} isActive={index===4} value={4} />
                <Button name={"Serve a website"} isActive={index===5} value={5} />
            </div>
        </section>
    )
